...
public class Main {
    public static void main(String[] args) {
        ...
        // (3)リスト内の要素で「【読了】」が含まれているものをリストから削除。
        books.removeIf(title -> title.contains("【読了】"));
        ...
        System.out.println("最初の本: " + books.get(0)); // 先頭の要素を取得して表示してください。
        System.out.println("最後の本: " + books.get(books.size() - 1)); // 末尾の要素を取得して表示してください。
    }
