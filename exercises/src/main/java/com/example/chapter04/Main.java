...
class Main {
    public static void main(String[] args) {
        ...
        Event e4 = new Event("開発相談会", 25, "会議室A");
        // 4件目: 所要時間を35分加算後、結果を表示する。
        // 4件目の期待出力結果: 予定: 開発相談会, 所要時間: 60分, 場所: 会議室A
        e4.addMinutes(35);
        System.out.println(e4.label());
        // 予定の総数を表示（期待: 4）
        System.out.println("作成された予定の総数: " + Event.getTotalEvents());
    }
}
